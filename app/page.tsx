// Three variants of the marketing homepage, switchable via `?variant=` on the existing `/` route. Default (no param) = current design.
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <p className="text-muted-foreground max-w-md font-sans text-sm md:text-base leading-relaxed">
              Stop digging through nested folders. Foleyard indexes your local
              drives and makes everything instantly searchable and playable.
            </p>
          </div>
