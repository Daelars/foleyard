...
import { AdminSiteClient } from "@/components/admin-site-client";
        ...
        {!userId ? (
          <div className="mx-auto flex min-h-[50vh] max-w-xl flex-col items-center justify-center rounded-2xl border border-border/50 bg-card/50 p-8 text-center shadow-xl backdrop-blur-sm">
            ...
            <p className="mb-8 text-sm leading-relaxed text-muted-foreground">
              Only Clerk users with the admin role can access the site settings.
            </p>
          ...
          <>
            ...
            <AdminSiteClient initialPageSlug={requestedPage} />
          </>
        )}
      </main>
